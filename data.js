...
    authorName: "B站@蛆肉儿串儿",
    reauthorName: "B站@厨厨",
    reauthorLink: "https://space.bilibili.com/还没起号呢",
    authorLink: "https://space.bilibili.com/417038183",
    hostText: "托管：Cloudflare (免费)",
    domainText: "域名：Spaceship (买不起)",
    
    // 按钮文本
    btnStart: "开始测试",
    btnBackToHome: "返回首页",
...
    
    // 进度提示文本
    hintIncomplete: "全选完才会放行。世界已经够乱了，起码把题做完整。",
    hintComplete: "都做完了。现在可以把你的电子魂魄交给结果页审判。",
    progressText: (done, total) => `${done} / ${total}`,
    
    // 题目页文本
    questionBadge: (index) => `第 ${index} 题`,
    questionMetaHidden: "维度已隐藏",
    questionMetaSpecial: "补充题",
    
    // 结果页标题
    resultSectionAnalysis: "该人格的简单解读",
    resultSectionDim: "十五维度评分",
    resultSectionNote: "友情提示",
    
    // 结果页逻辑文案（正常、隐藏、兜底 三种情况）
    calcKickerNormal: "你的主类型",
    calcSubNormal: "维度命中度较高，当前结果可视为你的第一人格画像。",
    calcBadgeNormal: (sim, exact) => `匹配度 ${sim}% · 精准命中 ${exact}/15 维`,
    
    calcKickerDrunk: "隐藏人格已激活",
    calcSubDrunk: "乙醇亲和性过强，系统已直接跳过常规人格审判。",
    calcBadgeDrunk: "匹配度 100% · 酒精异常因子已接管",
    
    calcKickerBottom: "系统强制兜底",
    calcSubBottom: "标准人格库对你的脑回路集体罢工了，于是系统把你强制分配给了 HHHH。",
    calcBadgeBottom: (sim) => `标准人格库最高匹配仅 ${sim}%`,
    
    // 免责/友情提示
    noteNormal: "本测试仅供娱乐，别拿它当诊断、面试、相亲、分手、招魂、算命或人生判决书。你可以笑，但别太当真。",
    noteSpecial: "本测试仅供娱乐。隐藏人格和傻乐兜底都属于作者故意埋的损招，请勿把它当成医学、心理学、相学、命理学或灵异学依据。",
    
    // 作者的话板块
    authorBoxSummary: "作者的话",
    authorBoxExpand: "展开",  // 展开按钮
    authorBoxCollapse: "收起", // 收起按钮
    authorBoxContent: [
...
// 1.需要参照模板，基于型月世界（动漫、小说、galgame等内容，不包含游戏内容）创建不同的丰富的多维度的人格类型er结尾，并合理补充缺失的人设，并依据人设以及心理学编写有趣的问题，创建合适的内容，替换模板中的所有内容以及提示（有趣、适度玩梗）。让圈外人也能轻松看懂，贴近主流社会内容将整理的内容输出成模板一致的data.js代码格式。保持数量、内容、格式和模板一一对应，做到直接data.js替换迁移

// 2. 为上述生成的人格生成一段用于动漫图片生成的文本描述（适度玩梗，贴近人格描述的人物形象、物体），用于ai图像生成，在最后整理成代码格式